...
def test_pass_struct_mismatch():
    ...
    with pytest.raises(
        ti.TaichiRuntimeTypeError,
        match=r"Argument <class 'gs_taichi.lang.struct.Struct.* cannot be converted into required type <ti"
        r".StructType center=<gs_taichi.lang.matrix.VectorType object at .*>, radius=f32, struct_methods={}>",
    ) as e:
