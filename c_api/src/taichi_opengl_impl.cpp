...
OpenglRuntime::OpenglRuntime()
    : GfxRuntime(gs_taichi::Arch::opengl),
      device_(),
      gfx_runtime_(gs_taichi::lang::gfx::GfxRuntime::Params{&device_}) {
  gs_taichi::lang::DeviceCapabilityConfig caps{};
  caps.set(gs_taichi::lang::DeviceCapability::spirv_has_int64, true);
  caps.set(gs_taichi::lang::DeviceCapability::spirv_has_float64, true);
  caps.set(gs_taichi::lang::DeviceCapability::spirv_version, 0x10300);
  get_gl().set_caps(std::move(caps));
}
gs_taichi::lang::Device &OpenglRuntime::get() {
  return static_cast<gs_taichi::lang::Device &>(device_);
}
gs_taichi::lang::gfx::GfxRuntime &OpenglRuntime::get_gfx_runtime() {
  return gfx_runtime_;
}
...
TiRuntime ti_import_opengl_runtime(TiOpenglRuntimeInteropInfo *interop_info,
  ...
  gs_taichi::lang::opengl::imported_process_address = interop_info->get_proc_addr;
  gs_taichi::lang::opengl::set_gles_override(use_gles);
...
void ti_export_opengl_runtime(TiRuntime runtime,
  ...
  interop_info->get_proc_addr =
      gs_taichi::lang::opengl::kGetOpenglProcAddr.value();
  TI_CAPI_TRY_CATCH_END();
}
...
TiMemory ti_import_opengl_memory(TiRuntime runtime,
  ...
  devalloc.alloc_id = (gs_taichi::lang::DeviceAllocationId)interop_info->buffer;
...
TiImage ti_import_opengl_image(TiRuntime runtime,
  ...
  OpenglRuntime *runtime2 = static_cast<OpenglRuntime *>((Runtime *)runtime);
  gs_taichi::lang::opengl::GLImageAllocation gl_image{};
  ...
  gs_taichi::lang::DeviceAllocation devalloc = runtime2->get_gl().import_image(
...
void ti_export_opengl_image(TiRuntime runtime,
  ...
  const gs_taichi::lang::opengl::GLImageAllocation &gl_image =
