...
namespace std {
template <>
struct hash<gs_taichi::lang::CFGFuncKey> {
  std::size_t operator()(const gs_taichi::lang::CFGFuncKey &key) const noexcept {
    return std::hash<gs_taichi::lang::FunctionKey>()(key.func_key) ^
