#include "gs_taichi/rhi/llvm/allocator.h"
#include "gs_taichi/runtime/llvm/snode_tree_buffer_manager.h"
...
uint64_t *CachingAllocator::allocate(
  ...
  auto size_aligned = gs_taichi::iroundup(params.size, taichi_page_size);
