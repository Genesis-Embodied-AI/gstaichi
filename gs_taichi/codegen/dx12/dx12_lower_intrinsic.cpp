...
using namespace gs_taichi::lang::directx12;
...
class TaichiIntrinsicLower : public ModulePass {
 public:
  bool runOnModule(Module &M) override {
    ...
    auto patch_intrinsic = [&](std::string name, Intrinsic::ID intrin,
      ...
      gs_taichi::lang::TaichiLLVMContext::mark_inline(func);
    };
  ...
  TaichiIntrinsicLower(const gs_taichi::lang::CompileConfig *config = nullptr)
 ...
 private:
  const gs_taichi::lang::CompileConfig *config;
};
