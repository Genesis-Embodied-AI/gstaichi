...
#include "gs_taichi/program/extension.h"
#include "gs_taichi/program/ndarray.h"
#include "gs_taichi/program/matrix.h"
#include "gs_taichi/python/export.h"
#include "gs_taichi/math/svd.h"
#include "gs_taichi/system/timeline.h"
#include "gs_taichi/python/snode_registry.h"
#include "gs_taichi/program/sparse_matrix.h"
#include "gs_taichi/program/sparse_solver.h"
#include "gs_taichi/program/conjugate_gradient.h"
#include "gs_taichi/aot/graph_data.h"
#include "gs_taichi/ir/mesh.h"
...
#include "gs_taichi/inc/archs.inc.h"
#undef PER_ARCH
      .export_values();
...
#include "gs_taichi/inc/extensions.inc.h"
#undef PER_EXTENSION
      .export_values();
...
#define PER_C_TYPE(type, ctype)                                           \
  case PrimitiveTypeID::type:                                             \
    ...
    break;
#include "gs_taichi/inc/data_type_with_c_type.inc.h"
#undef PER_C_TYPE
            default:
...
#define PER_TYPE(x)                                                  \
  m.attr(("DataType_" + data_type_name(PrimitiveType::x)).c_str()) = \
      PrimitiveType::x;
#include "gs_taichi/inc/data_type.inc.h"
#undef PER_TYPE
...
#define PER_INTERNAL_OP(x)                                           \
  internalOpClass.def_property_readonly_static(                      \
      ...
      py::return_value_policy::reference);
#include "gs_taichi/inc/internal_ops.inc.h"
