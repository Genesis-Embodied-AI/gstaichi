...
// objdump -T libgs_taichi_python.so| grep  GLIBC_2.27
...
#include "gs_taichi/platform/windows/windows.h"
#pragma warning(pop)
#include <intrin.h>
#endif  // _WIN64
...
#include "gs_taichi/common/serialization.h"
