...
if(LINUX)
target_link_libraries(${CORE_LIBRARY_NAME} PUBLIC -Wl,--whole-archive taichi_util -Wl,--no-whole-archive)
target_link_libraries(${CORE_LIBRARY_NAME} PUBLIC -Wl,--whole-archive taichi_common -Wl,--no-whole-archive)
elseif(WIN32)
target_link_libraries(${CORE_LIBRARY_NAME} PUBLIC -WHOLEARCHIVE:taichi_util)
target_link_libraries(${CORE_LIBRARY_NAME} PUBLIC -WHOLEARCHIVE:taichi_common)
else()
