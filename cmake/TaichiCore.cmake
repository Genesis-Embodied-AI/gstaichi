...
if (TI_WITH_AMDGPU)
  ...
  list(APPEND TAICHI_CORE_SOURCE ${TAICHI_AMDGPU_RUNTIME_SOURCE})
endif()
...
target_link_libraries(${CORE_LIBRARY_NAME} PRIVATE gs_taichi_util)
target_link_libraries(${CORE_LIBRARY_NAME} PRIVATE gs_taichi_common)
