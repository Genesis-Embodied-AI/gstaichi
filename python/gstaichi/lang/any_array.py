...
def get_addr(arr, indices):
    ...
    Args:
        arr: Input ndarray (passed as kernel argument via ti.types.ndarray()).
        indices (List[int]): The specified indices for the query.

    Returns:
        ti.u64: The memory address of `arr[indices]`.
